...
questions_list = [] 
questions_list.append(Question('Какова столица Германии', 'Берлин', 'Мюнхен', 'Франкфурт', 'Гамбург'))
questions_list.append(Question('Основной язык в России', 'Русский', 'Английский', 'Португальский','Китайский'))
